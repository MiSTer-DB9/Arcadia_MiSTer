...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcadia_MiSTer.git"
CORE_NAME=(Arcadia)
...
UPSTREAM_CORE_NAME=(Arcadia)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(arcadia.qpf)
COMPILATION_OUTPUT=(output_files/arcadia.rbf)
